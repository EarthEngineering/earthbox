...
const {constants} = require('./EarthWrap')
...
const DEFAULT_CONFIG_FILENAME = 'earthbox.js'
const BACKUP_CONFIG_FILENAME = 'earthbox-config.js' // For Windows + Command Prompt
...
>>>>>>> 579001f13f560effe3a1a59575ea42ac963107b9
